...
cpp_const = (bparser_cpp_const + exprtk_cpp_const) / 2
...
cpp_simple = (bparser_cpp_simple + exprtk_cpp_simple) / 2
...
cpp_complex = (bparser_cpp_complex + exprtk_cpp_complex) / 2
...
cpp_power = (bparser_cpp_power + exprtk_cpp_power) / 2
...
#muparser_parse_power = np.array(df_muparser.iloc[5, 1:9], dtype=float) / m_samples
